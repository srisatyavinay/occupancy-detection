...
const char* ssid     = "POCO X2";   //your network SSID
const char* password = "0987654321";   //your network password

String myScript = "/macros/s/AKfycbykiNtByhum5AEUBMOHEQ48DR0kN0ZevHAbqweV8KaXaMHA2JzX/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String myFoldername = "&myFoldername=ESW-Photos";
...
const char * myReadAPIKey = "9DL4JXYDG8C6P32U";
String prevTime = "";
int i = 0;
...
void loop()
{
  String currTime = ThingSpeak.readCreatedAt(myChannelNumber, myReadAPIKey);
  Serial.println(i);
  i++;
